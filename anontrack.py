...
def banner():
	...
	r'''
                                     ...
                                     _                        __    
       _____    ____   ____   _____/  |_____________    ____ |  | __
       \__  \  /    \ /  _ \ /    \   __\_  __ \__  \ _/ ___\|  |/ /
        / __ \|   |  (  <_> )   |  \  |  |  | \// __ \\  \___|    < 
       (____  /___|  /\____/|___|  /__|  |__|  (____  /\___  >__|_ \
            \/     \/            \/                 \/     \/     \/.  ''' + W)
	print('\n' + G + '[>]' + C + ' Created By : ' + W + 'AnXsec Syndicate')
	print(G + '[>]' + C + ' Version    : ' + W + version + '\n')

def ver_check():
	print(G + '[+]' + C + ' Checking for Updates.....', end='')
	ver_url = 'https://raw.githubusercontent.com/AnXsec-Syndicate/anontrack/master/version.txt'
	try:
